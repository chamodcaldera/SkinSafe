...
def connection():
    ...
    #     host='mysql-77609-0.cloudclusters.net',
    #     port=11976,
    #     user='admin',
    #     password='fOHh2cA0',
    #     db='skinsafe',
    #     server_public_key='mysql-77609-db.mysql-77609:11976',
    #
    #
    # )
    ...
    mycursor.execute("CREATE TABLE IF NOT EXISTS Channelling (channelId INT NOT NULL AUTO_INCREMENT, id INT NOT NULL,name VARCHAR (50) NOT NULL ,channel_date VARCHAR (10) NOT NULL,channel_time  VARCHAR (10)  NOT NULL ,appointment_Num  VARCHAR (10)  NOT NULL , doctorId INT NOT NULL, status VARCHAR(10),message VARCHAR(100), PRIMARY KEY (channelId), FOREIGN KEY (id)REFERENCES User (id) ON DELETE CASCADE,FOREIGN KEY (doctorId)REFERENCES Doctor (docId) ON DELETE CASCADE)")  # Execute SQL Query to create a table into your database
