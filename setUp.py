...
def connection():
    ...
    mycursor.execute("CREATE TABLE IF NOT EXISTS Chanelling (channelId INT NOT NULL AUTO_INCREMENT, id INT NOT NULL,channel_date VARCHAR (10) NOT NULL,channel_time  VARCHAR (10)  NOT NULL , doctorId INT NOT NULL, status VARCHAR(10),message VARCHAR(100), PRIMARY KEY (channelId), FOREIGN KEY (id) REFERENCES User(id), FOREIGN KEY (doctorId) REFERENCES doctor(docId))")  # Execute SQL Query to create a table into your database
